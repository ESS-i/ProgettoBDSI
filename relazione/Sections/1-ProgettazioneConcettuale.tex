...
Una volta terminato lo scheletro di base, aggiungiamo gli attributi alle varie entità, già  e determiniamo le cardinalità delle partecipazioni. Lo schema risultante è il seguente:
%TODO: Inserire i due schemi finali
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|l|X|X|}
        ...
        \hline
        \textbf{Vigile} & Personale operativo che interviene nelle emergenze & GradoVigile, RepartoVigile \\
        \hline
        ...
        \hline
        \textbf{Chiamata} & Potenziale richiesta di intervento ricevuta dalla centrale operativa & \textbf{CodChiam}, OraInizioChiam, OraFineChiam, NumChiamante, DescrChiamata \\
        \hline
        \textbf{Intervento} & Operazione di soccorso effettuata a seguito di una chiamata valida & \textbf{CodIntervento}, TipoInt, PrioritàInt, OraInizioInt, OraFineInt, EsitoInt \\
        \hline
        \textbf{Squadra} & Gruppo di vigili che opera congiuntamente negli interventi & \textbf{CodSquad}, DenomOper, AreaComp, DataCostit \\
        \hline
        \textbf{Mezzo} & Veicolo o attrezzatura utilizzata negli interventi & \textbf{CodMezzo}, Classe, Modello, AnnoFabb, DataUltimaManut \\
        \hline
        \textbf{Manutenzione} & Attività di controllo e riparazione effettuata sui mezzi & \textbf{CodManut}, DataRichiestaManut, DataSvolg, TipoManut (ordinaria/straordinaria), SpesaManut, DescrManut \\
        \hline
...
\begin{longtable}{|c|p{\dimexpr\textwidth-3cm\relax}|}
    ...
    \hline
    V5 & Una squadra deve essere composta da almeno 3 vigili attivi (vincolo di cardinalità minima complesso). \\
    \hline
    V6 & Un mezzo non può essere impiegato contemporaneamente in due interventi che si sovrappongono temporalmente. \\
    \hline
    V7 & Solo il personale amministrativo con l'attributo \textit{AbilitFirma} impostato a \textit{true} può effettuare richieste di manutenzione. \\
    \hline
    V8 & Un mezzo può essere impiegato in un intervento solo se risulta "a norma", ovvero se la \textit{DataUltimaManut} non è antecedente di oltre un anno rispetto alla data dell'intervento. \\
    \hline
\end{longtable}