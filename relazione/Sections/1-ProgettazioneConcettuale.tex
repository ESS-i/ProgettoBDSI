...
\begin{table}[h!]
    ...
    \begin{tabularx}{\textwidth}{|p{3.5cm}|X|X|}
        \hline
        \rowcolor{lightgrey} 
        \multicolumn{1}{|c|}{\textbf{Relazione}} & \multicolumn{1}{c|}{\textbf{Entità e Cardinalità}} & \multicolumn{1}{c|}{\textbf{Descrizione da Specifiche}} \\
        \hline
        
        \textbf{LAVORARE} & \textbf{Caserma} (1,N) \newline \textbf{Dipendente} (1,1) & Ogni dipendente lavora in una specifica caserma di riferimento; una caserma ha molti dipendenti. \\
        \hline
        
        \textbf{RISPONDE} & \textbf{Centralinista} (0,N) \newline \textbf{Chiamata} (1,1) & Il compito del centralinista è ricevere le chiamate. Ogni chiamata è gestita da un solo operatore. \\
        \hline
        
        \textbf{GENERA} & \textbf{Chiamata} (0,1) \newline \textbf{Intervento} (1,1) & Una chiamata può risolversi in un intervento o meno (0 o 1). Un intervento nasce sempre da una chiamata specifica (1). \\
        \hline
        
        \textbf{ASSEGNATO A} & \textbf{Intervento} (1,1) \newline \textbf{Squadra} (0,N) & L'intervento viene assegnato ad una squadra. Una squadra può effettuare più interventi nel tempo. \\
        \hline
        
        \textbf{IMPIEGATO IN} & \textbf{Mezzo} (0,N) \newline \textbf{Intervento} (0,N) & A supporto dell'operazione possono essere impiegati uno o più mezzi. Un mezzo può essere usato in più interventi storici. \\
        \hline
        
        \textbf{APPARTENENZA} & \textbf{Vigile} (0,1) \newline \textbf{Squadra} (1,N) & Ogni vigile può far parte al massimo di una squadra (V14). Una squadra è composta da più vigili (V15). \\
        \hline
        
        \textbf{AFFERENZA} & \textbf{Squadra} (1,1) \newline \textbf{Amministrativo} (0,N) & La squadra afferisce ad un particolare amministrativo che la supervisiona. \\
        \hline
        
        \textbf{RICHIEDE} & \textbf{Amministrativo} (0,N) \newline \textbf{Manutenzione} (1,1) & Le manutenzioni sono richieste dal personale amministrativo. Ogni richiesta parte da un solo amministrativo. \\
        \hline
        
        \textbf{EFFETTUATA SU} & \textbf{Manutenzione} (1,1) \newline \textbf{Mezzo} (0,N) & Le manutenzioni riguardano uno specifico mezzo. Un mezzo subisce varie manutenzioni nel tempo. \\
        \hline
        
        \textbf{REALIZZATE DA} & \textbf{Manutenzione} (1,1) \newline \textbf{Officina} (0,N) & Le manutenzioni sono svolte da officine convenzionate. Un'officina può svolgere più manutenzioni. \\
        \hline
    \end{tabularx}
\end{table}
