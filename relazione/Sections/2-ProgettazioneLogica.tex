...
Non sono presenti attributi multivalore, che avremmo comunque dovuto rimuovere in quanto non rappresentabili usando il modello relazionale.
...
\textbf{Dipendente}(\underline{CodDip}, NomeDip, CognomeDip, Stipendio, *GradoVigile, *AnnoAssunzione, *OrarioTurno, *MansioneAmm, *LivFunzionale, *AbilitFirma, CodSquad\footnote{Nota: un dipendente potrebbe anche non essere vigile, quindi nel nostro db lo abbiamo considerato come possibile null, anche se in realtà la partecipazione è obbligatoria nello schema E-R.}, *DataEntrata, *DataUscita, CodCaserma)\\
