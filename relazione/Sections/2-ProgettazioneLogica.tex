...
\textbf{Gestisce}(\underline{CodSquad}, \underline{CodInt})\\
\textbf{Intervento}(\underline{CodInt}, TipoInt, PrioritàInt, OraFineInt, EsitoInt, \dashuline{CodChiam})\\
\textbf{Mezzo}(\underline{CodMezzo}, ClasseMezzo, ModelloMezz, AnnoFabbMezzo, DataUltManut, CodInt)\\
...
\textbf{Officina}(\underline{CodOff}, TelOff, NomeOff, CittàOff, ViaOff, CivicaOff, CapOff)
...
Mezzo.CodInt \rightarrow Intervento.CodInt\\
...
Gestisce.CodSquad \rightarrow Squadra.CodSquad\\
Gestisce.CodInt \rightarrow Intervento.CodInt\\
