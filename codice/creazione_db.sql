...
LOAD DATA LOCAL INFILE 'C:/Users/silvi/ProgettoBDSI/codice/dati/convenzione.csv' 
INTO TABLE Convenzione 
FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"'LINES TERMINATED BY '\r\n' IGNORE 1 ROWS;

LOAD DATA LOCAL INFILE 'C:/Users/silvi/ProgettoBDSI/codice/dati/squadra.csv' 
INTO TABLE Squadra 
FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"'LINES TERMINATED BY '\r\n' IGNORE 1 ROWS;

LOAD DATA LOCAL INFILE 'C:/Users/silvi/ProgettoBDSI/codice/dati/dipendente.csv' 
...
LOAD DATA LOCAL INFILE 'C:/Users/silvi/ProgettoBDSI/codice/dati/mezzo.csv' 
INTO TABLE Mezzo 
FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"'LINES TERMINATED BY '\r\n' IGNORE 1 ROWS
(CodMezzo, ClasseMezzo, ModelloMezzo, AnnoFabbMezzo, @DataUltManut)
SET DataUltManut = NULLIF(@DataUltManut, '');

LOAD DATA LOCAL INFILE 'C:/Users/silvi/ProgettoBDSI/codice/dati/chiamata.csv' 
INTO TABLE Chiamata 
FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"'LINES TERMINATED BY '\r\n' IGNORE 1 ROWS;

LOAD DATA LOCAL INFILE 'C:/Users/silvi/ProgettoBDSI/codice/dati/intervento.csv' 
INTO TABLE Intervento 
FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"'LINES TERMINATED BY '\r\n' IGNORE 1 ROWS;

LOAD DATA LOCAL INFILE 'C:/Users/silvi/ProgettoBDSI/codice/dati/assegnatoa.csv' 
INTO TABLE AssegnatoA 
FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"'LINES TERMINATED BY '\r\n' IGNORE 1 ROWS;

LOAD DATA LOCAL INFILE 'C:/Users/silvi/ProgettoBDSI/codice/dati/impiegatoin.csv' 
INTO TABLE ImpiegatoIn 
FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"'LINES TERMINATED BY '\r\n' IGNORE 1 ROWS;

LOAD DATA LOCAL INFILE 'C:/Users/silvi/ProgettoBDSI/codice/dati/manutenzione.csv' 
